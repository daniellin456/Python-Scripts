...
sed -i '5s/'$original_G0_factor'/'$modified_G0_factor'/' /data/daniellin/COOLING_FUNCTION_ANALYZE/EQUILIBRIUM/equilibrium_temp.py
python3 /data/daniellin/COOLING_FUNCTION_ANALYZE/EQUILIBRIUM/equilibrium_temp.py
