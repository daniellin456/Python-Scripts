...
def dCoolingdTemp(nH, T, x):
    ...
    if x >= 0.1:
        ...
        dOI_Line_CoolingdTemp = 1.6563858962105e-29 * np.exp(-49000.0 / T) / (
            ...
            -26000.0 / T) / T ** 2
        dRecombination_CoolingdTemp = 8.39926244762003e-33 * T ** 0.19 * (387.534026981419 * T ** 0.25) ** bet / nH + 7.05820373749582e-33 * T ** 1.19 * (387.534026981419 * T ** 0.25) ** bet * (-0.05032 * np.log(
